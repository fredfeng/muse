...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 We combine the advantages of both statistical model and SMT-based program Synthesis: 
   ...
   \item Using type-directed component-based Synthesis to generate adaptor code for the candidate Algorithm; 
   \item Using SMT-based to find the solution which minimizes the cost of Synthesis.
   \end{enumerate}
