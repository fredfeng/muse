...
%  background=shade-tb,
  ...
  % Title
  {\bf\textsc{Apposcopy: Automated Detection of Android Malware}\vspace{0.1em}}
  % Authors
  {\textsc{\{ Yu Feng, Isil Dillig \}@UT Austin \qquad  \{Saswat Anand, Alex Aiken\}@Stanford University}}
  % University logo
